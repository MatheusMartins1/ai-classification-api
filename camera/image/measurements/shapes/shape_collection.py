...
class MeasurementShapeCollectionManager:
    """
    Holds the measurement shape collection functionality.
    """

    def __init__(self, _camera):
        """
        Initialize the MeasurementShapeCollectionManager class with a camera instance.
        """
