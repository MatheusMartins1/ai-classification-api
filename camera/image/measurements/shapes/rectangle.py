...
class MeasurementRectangleManager(MeasurementShapeManager):
    """
    Holds the measurement rectangle functionality.
    """

    def __init__(self, _camera):
        """
        Initialize the MeasurementRectangleManager class with a camera instance.
        """
