...
class MeasurementPolyLineManager:
    """
    Holds the measurement polyline functionality.

    its a subclass of line
    """

    def __init__(self, _camera):
        """
        Initialize the MeasurementPolyLineManager class with a camera instance.
        """
